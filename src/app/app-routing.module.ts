...
const routes: Routes = [
  ...
  {
    path: 'post',
    loadChildren: () => import('./page/post/post.module').then( (m) => m.PostPageModule)
  },

  {
    ...
    loadChildren: () => import('./page/trilhas/trilhas.module').then( (m) => m.TrilhasPageModule)
...

  {
    ...
    loadChildren: () => import('./page/restaurante/restaurante.module').then( (m) => m.RestaurantePageModule)
...

  {
    ...
    loadChildren: () => import('./page/bares/bares.module').then( (m) => m.BaresPageModule)
...

  {
    path: 'favorite',
    loadChildren: () =>
    import('./page/favorite/favorite.module').then( (m) => m.FavoritePageModule)
  },
